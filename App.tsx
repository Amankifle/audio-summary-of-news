...
function App() {
  ...
  const handleGenerate = useCallback(async () => {
    ...
    try {
      ...
      const generatedSummary = await generateSummary(article, persona);
      setSummary(generatedSummary);

      setLoadingStep('Generating audio...');
      const generatedAudioB64 = await generateSpeech(generatedSummary);
        ...
        <main>
          ...
          {(summary || audioB64) && !isLoading && (
            <div className="mt-8 bg-gray-800 rounded-lg shadow-xl p-6">
              <h2 className="text-2xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-teal-400">Your Summary</h2>
